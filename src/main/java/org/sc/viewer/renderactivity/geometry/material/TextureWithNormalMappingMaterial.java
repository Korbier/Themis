...
public class TextureWithNormalMappingMaterial extends Material {
  ...
  public static final String FRAGMENT_SOURCE =
      ...
      """
            ...
            void main() {
                ...
                vec3 normal = texture(normalSampler, inTexture).rgb;
  ...
  public static final String MATERIAL_ID = "material.texture-with-normalmapping";
  private static final VkSamplerDescriptor DESCRIPTOR = new VkSamplerDescriptor(VK_FILTER_LINEAR, 1, true);

  public TextureWithNormalMappingMaterial(
