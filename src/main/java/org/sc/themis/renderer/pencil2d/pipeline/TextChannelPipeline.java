...
public class TextChannelPipeline implements LifeCycle, Pencil2DChannelPipeline {
  ...
  public TextChannelPipeline(Renderer renderer, VkRenderPass pass, VkDescriptorSetLayout layout) {
