...
public class VulkanSurface extends Vulkan {
  ...
  public void getPhysicalDeviceSurfaceCapabilities(
      VkPhysicalDevice physicalDevice, long surface, VkSurfaceCapabilitiesKHR pSurfaceCapabilities)
      throws ThemisException {
    vk(
        () ->
  ...
  public void getPhysicalDeviceSurfaceFormatsKHR(
      VkPhysicalDevice physicalDevice,
      long surface,
      IntBuffer pSurfaceFormatCount,
  ...
  public void createSwapchainKHR(
      VkDevice device, VkSwapchainCreateInfoKHR pCreateInfo, LongBuffer pSwapchain)
      throws ThemisException {
    vk(
  ...
  public void getSwapchainImagesKHR(
      VkDevice device, long swapchain, IntBuffer pSwapchainImageCount, LongBuffer pSwapchainImages)
      throws ThemisException {
    vk(
        () ->
