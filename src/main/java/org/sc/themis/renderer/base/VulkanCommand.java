...
public class VulkanCommand extends Vulkan {
  ...
  public void createCommandPool(
      VkDevice device, VkCommandPoolCreateInfo pCreateInfo, LongBuffer pCommandPool)
  ...
  public void allocateCommandBuffers(
      VkDevice device, VkCommandBufferAllocateInfo pAllocateInfo, PointerBuffer pCommandBuffers)
      throws ThemisException {
    vk(
  ...
  public void freeCommandBuffers(VkDevice device, long commandPool, VkCommandBuffer pCommandBuffers)
      throws ThemisException {
    vk(() -> vkFreeCommandBuffers(device, commandPool, pCommandBuffers));
  }

  public void beginCommandBuffer(VkCommandBuffer commandBuffer, VkCommandBufferBeginInfo pBeginInfo)
      throws ThemisException {
    vk(
  ...
  public void queueSubmit(VkQueue queue, VkSubmitInfo.Buffer pSubmits, long fence)
      throws ThemisException {
    vk(
  ...
  public void cmdBeginRenderPass(
      VkCommandBuffer commandBuffer, VkRenderPassBeginInfo pRenderPassBegin, int contents)
      throws ThemisException {
  ...
  public void cmdSetViewport(VkCommandBuffer commandBuffer, VkViewport.Buffer viewports)
      throws ThemisException {
    vk(() -> vkCmdSetViewport(commandBuffer, 0, viewports));
  }

  public void cmdSetScissor(VkCommandBuffer commandBuffer, VkRect2D.Buffer scissors)
      throws ThemisException {
  ...
  public void cmdBindVertexBuffers(
      VkCommandBuffer commandBuffer, int firstBinding, LongBuffer pBuffers, LongBuffer pOffsets)
      throws ThemisException {
    vk(() -> vkCmdBindVertexBuffers(commandBuffer, firstBinding, pBuffers, pOffsets));
  }

  public void cmdBindIndexBuffer(
      VkCommandBuffer commandBuffer, long buffer, long offset, int indexType)
      throws ThemisException {
  ...
  public void cmdBindPipeline(VkCommandBuffer commandBuffer, int pipelineBindPoint, long pipeline)
      throws ThemisException {
  ...
  public void cmdCopyImage(
    ...
    vk(
        () ->
            vkCmdCopyImage(
                commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, pRegions));
  }

  public void cmdCopyBuffer(
      VkCommandBuffer commandBuffer, long srcBuffer, long dstBuffer, VkBufferCopy.Buffer pRegions)
      throws ThemisException {
    ...
    vk(
        () ->
            vkCmdPipelineBarrier(
                commandBuffer, srcStageMask, dstStageMask, 0, null, null, pImageMemoryBarriers));
  }

  public void cmdPushConstants(
      VkCommandBuffer commandBuffer, long layout, int stageFlags, int offset, ByteBuffer pValues)
      throws ThemisException {
