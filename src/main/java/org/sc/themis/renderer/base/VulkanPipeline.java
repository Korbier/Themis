...
public class VulkanPipeline extends Vulkan {
    ...
    public void updateDescriptorSets(VkDevice device, VkWriteDescriptorSet.Buffer pDescriptorWrites, VkCopyDescriptorSet.Buffer pDescriptorCopies) throws ThemisException {
