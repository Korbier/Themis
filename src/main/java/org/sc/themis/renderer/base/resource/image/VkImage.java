...
public class VkImage extends Vulkan implements LifeCycle {
  ...
  public String toString() {
    return getClass().getSimpleName()
        ...
        + " memory_handle="
        + Long.toHexString(getMemoryHandle())
        + "}";
  }
  ...
  private VkMemoryAllocateInfo vkCreateMemoryAllocateInfo(MemoryStack stack)
      throws ThemisException {
        ...
        .memoryTypeIndex(
            this.device
                ...
                .memoryTypeFromProperties(
                    memReqs.memoryTypeBits(), this.descriptor.memoryTypeIndex()));
  }
}
