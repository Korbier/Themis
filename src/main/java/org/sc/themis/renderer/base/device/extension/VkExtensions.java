...
public class VkExtensions extends VulkanObject {
  ...
  /**
   * Filters the given list of VkExtensions based on the availability in the internal list of
   * extensions.
   *
   ...
   * @throws ThemisException if an error occurs during the enumeration of instance extension
   *     properties
   */
