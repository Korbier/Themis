...
public record VkFrameBufferDescriptor(
    int width, int height, int layers, long renderpass, long... imageViews) {
  ...
  public VkFrameBufferDescriptor(
      int width, int height, int layers, long renderpass, long... imageViews) {
    this.width = width;
    this.height = height;
    this.layers = layers;
  ...
  public VkFrameBufferDescriptor(
      VkExtent2D extent, int layers, long renderpass, long... imageViews) {
