...
public class VkPipeline extends VulkanObject {
  ...
  private VkGraphicsPipelineCreateInfo.Buffer createGraphicPipelineCreateInfo(
    ...
    VkGraphicsPipelineCreateInfo.Buffer graphicPipelineCreateInfo =
  ...
  private VkPipelineDepthStencilStateCreateInfo createDepthStencilStateCreateInfo(
      MemoryStack stack) {
  ...
  private VkPipelineShaderStageCreateInfo.Buffer createShaderStageCreateInfo(MemoryStack stack) {
    ...
    VkPipelineShaderStageCreateInfo.Buffer shaderStageCreateInfo =
        VkPipelineShaderStageCreateInfo.calloc(this.shaderProgram.size(), stack);
  ...
  private VkPipelineMultisampleStateCreateInfo createMultisamplingStateCreateInfo(
      MemoryStack stack) {
  ...
  private VkPipelineColorBlendStateCreateInfo createColorBlendStateCreateInfo(MemoryStack stack) {
    ...
    VkPipelineColorBlendAttachmentState.Buffer blendAttachmentState =
