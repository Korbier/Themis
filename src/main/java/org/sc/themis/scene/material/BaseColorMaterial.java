...
/**
 * Color material.
 * Apply to the mesh the color defined on MeshProperties.COLOR_BASE attribute
 */
public class BaseColorMaterial extends BaseMaterial {
    ...
    public final static String MATERIAL_ID = "Material.BaseColorMaterial";
    ...
    public BaseColorMaterial(Configuration configuration, Renderer renderer, VkRenderPass renderPass, SceneDescriptorSet sceneDescriptorSet ) {
