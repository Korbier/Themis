...
public class MeshFactory {
  ...
  public Mesh create(
      VkStagingResourceAllocator allocator, String identifier, Vertex[] vertices, int[] indices)
  ...
  public Mesh createTriangle(VkStagingResourceAllocator allocator, String identifier)
      throws ThemisException {
    return create(
        allocator,
        identifier,
  ...
  public Mesh createCube(VkStagingResourceAllocator allocator, String identifier)
      throws ThemisException {
    return create(
        allocator,
        identifier,
