...
public class ControllerFpsCameraRendererActivity extends BaseRendererActivity {
    ...
    private final static String SHADER_VERTEX_SOURCE = "src/main/resources/playground/controller/fpscamera/vertex_shader.glsl";
    private final static String SHADER_VERTEX_COMPILED = "target/playground/controller/fpscamera/vertex_shader.spirv";
    private final static String SHADER_FRAGMENT_SOURCE = "src/main/resources/playground/controller/fpscamera/fragment_shader.glsl";
    private final static String SHADER_FRAGMENT_COMPILED = "target/playground/controller/fpscamera/fragment_shader.spirv";
    ...
    public ControllerFpsCameraRendererActivity(Configuration configuration) {
        super(configuration);
    }
