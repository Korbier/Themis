...
public class PushConstantRendererActivity extends BaseRendererActivity {
  ...
  private static final String SHADER_VERTEX_SOURCE =
      "src/main/resources/playground/pushconstant/vertex_shader.glsl";
  private static final String SHADER_VERTEX_COMPILED =
      "target/playground/pushconstant/vertex_shader.spirv";
  private static final String SHADER_FRAGMENT_SOURCE =
      "src/main/resources/playground/pushconstant/fragment_shader.glsl";
  private static final String SHADER_FRAGMENT_COMPILED =
      "target/playground/pushconstant/fragment_shader.spirv";
    ...
    this.pipelineLayout =
        new VkPipelineLayout(
            ...
            new VkPushConstantRange[] {
              ...
              new VkPushConstantRange(
                  VK_SHADER_STAGE_FRAGMENT_BIT, MemorySizeUtils.MAT4x4F, MemorySizeUtils.MAT4x4F)
            });
