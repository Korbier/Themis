...
public class MousePickingRendererActivity extends RendererActivity {
  ...
  private static final String SHADER_0_VERTEX_SOURCE =
      "src/main/resources/playground/mousepicking/0_vertex_shader.glsl";
  private static final String SHADER_0_VERTEX_COMPILED =
      "target/playground/mousepicking/0_vertex_shader.spirv";
  private static final String SHADER_0_FRAGMENT_SOURCE =
      "src/main/resources/playground/mousepicking/0_fragment_shader.glsl";
  private static final String SHADER_0_FRAGMENT_COMPILED =
      "target/playground/mousepicking/0_fragment_shader.spirv";

  private static final String SHADER_1_VERTEX_SOURCE =
      "src/main/resources/playground/mousepicking/1_vertex_shader.glsl";
  private static final String SHADER_1_VERTEX_COMPILED =
      "target/playground/mousepicking/1_vertex_shader.spirv";
  private static final String SHADER_1_FRAGMENT_SOURCE =
      "src/main/resources/playground/mousepicking/1_fragment_shader.glsl";
  private static final String SHADER_1_FRAGMENT_COMPILED =
      "target/playground/mousepicking/1_fragment_shader.spirv";

  private static final String SHADER_2_VERTEX_SOURCE =
      "src/main/resources/playground/mousepicking/2_vertex_shader.glsl";
  private static final String SHADER_2_VERTEX_COMPILED =
      "target/playground/mousepicking/2_vertex_shader.spirv";
  private static final String SHADER_2_FRAGMENT_SOURCE =
      "src/main/resources/playground/mousepicking/2_fragment_shader.glsl";
  private static final String SHADER_2_FRAGMENT_COMPILED =
      "target/playground/mousepicking/2_fragment_shader.spirv";
  ...
  public void render(Scene scene, long tpf) throws ThemisException {
    ...
    VkDescriptorSet mousePickingDescriptorSet =
        this.mousePickingDescriptorSet.getDescriptorSet(frame);
  ...
  private void setupDescriptorSets() throws ThemisException {
    ...
    this.mousePickingDescriptorSet =
        new MousePickingDescriptorSet(getConfiguration(), this.renderer);
    this.mousePickingDescriptorSet.setup();

    this.subpass1DescriptorSet =
        new FramebufferAttachmentDescriptorSet(
            getConfiguration(),
            this.renderer,
            this.frameBufferAttachments.get(FB_ATTACHMENT_IDENTIFIER));
  ...
  private void setupFramebufferAttachments() throws ThemisException {
    ...
    this.frameBufferAttachments.color(
        FB_ATTACHMENT_IDENTIFIER,
  ...
  private VkRenderPassDescriptor createSubPassDescriptor(VkDevice device) {
    ...
    VkRenderPassLayout layout =
        new VkRenderPassLayout()
            ...
            .add(
                2,
                this.frameBufferAttachments.get(FB_ATTACHMENT_IDENTIFIER).getFormat(),
                VK_IMAGE_LAYOUT_UNDEFINED,
  ...
  private void setupShaderProgram0() throws ThemisException {
    try {
      VkShaderSourceCompiler.compileShaderIfChanged(
          SHADER_0_VERTEX_SOURCE, SHADER_0_VERTEX_COMPILED, Shaderc.shaderc_glsl_vertex_shader);
      VkShaderSourceCompiler.compileShaderIfChanged(
          SHADER_0_FRAGMENT_SOURCE,
          SHADER_0_FRAGMENT_COMPILED,
          Shaderc.shaderc_glsl_fragment_shader);
      VkShaderProgramStage vertexStage =
          new VkShaderProgramStage(
              VK_SHADER_STAGE_VERTEX_BIT, Files.readAllBytes(Paths.get(SHADER_0_VERTEX_COMPILED)));
      VkShaderProgramStage fragmentStage =
          new VkShaderProgramStage(
              VK_SHADER_STAGE_FRAGMENT_BIT,
              Files.readAllBytes(Paths.get(SHADER_0_FRAGMENT_COMPILED)));
      this.shaderProgram0 =
  ...
  private void setupShaderProgram1() throws ThemisException {
    try {
      VkShaderSourceCompiler.compileShaderIfChanged(
          SHADER_1_VERTEX_SOURCE, SHADER_1_VERTEX_COMPILED, Shaderc.shaderc_glsl_vertex_shader);
      VkShaderSourceCompiler.compileShaderIfChanged(
          SHADER_1_FRAGMENT_SOURCE,
          SHADER_1_FRAGMENT_COMPILED,
          Shaderc.shaderc_glsl_fragment_shader);
      VkShaderProgramStage vertexStage =
          new VkShaderProgramStage(
              VK_SHADER_STAGE_VERTEX_BIT, Files.readAllBytes(Paths.get(SHADER_1_VERTEX_COMPILED)));
      VkShaderProgramStage fragmentStage =
          new VkShaderProgramStage(
              VK_SHADER_STAGE_FRAGMENT_BIT,
              Files.readAllBytes(Paths.get(SHADER_1_FRAGMENT_COMPILED)));
      this.shaderProgram1 =
          new VkShaderProgram(getConfiguration(), renderer.getDevice(), vertexStage, fragmentStage);
  ...
  private void setupPipeline1() throws ThemisException {
    ...
    try (MemoryStack stack = MemoryStack.stackPush()) {
      ...
      VkVertexInputStateDescriptor descriptor =
          new VkVertexInputStateDescriptor(VK_VERTEX_INPUT_RATE_VERTEX); // Bitangent
      VkVertexInputState inputState = new VkVertexInputState(descriptor);
      inputState.setup(stack);
  ...
  private void setupShaderProgram2() throws ThemisException {
    try {
      VkShaderSourceCompiler.compileShaderIfChanged(
          SHADER_2_VERTEX_SOURCE, SHADER_2_VERTEX_COMPILED, Shaderc.shaderc_glsl_vertex_shader);
      VkShaderSourceCompiler.compileShaderIfChanged(
          SHADER_2_FRAGMENT_SOURCE,
          SHADER_2_FRAGMENT_COMPILED,
          Shaderc.shaderc_glsl_fragment_shader);
      VkShaderProgramStage vertexStage =
          new VkShaderProgramStage(
              VK_SHADER_STAGE_VERTEX_BIT, Files.readAllBytes(Paths.get(SHADER_2_VERTEX_COMPILED)));
      VkShaderProgramStage fragmentStage =
          new VkShaderProgramStage(
              VK_SHADER_STAGE_FRAGMENT_BIT,
              Files.readAllBytes(Paths.get(SHADER_2_FRAGMENT_COMPILED)));
      this.shaderProgram2 =
          new VkShaderProgram(getConfiguration(), renderer.getDevice(), vertexStage, fragmentStage);
