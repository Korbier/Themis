...
public class ColorMaterialRenderer extends MaterialRenderer {
  ...
  private static final VkBufferDescriptor BUFFER_DESCRIPTOR = VkBufferDescriptor.descriptorsetDynamicUniform(BUFFER_SIZE, 3);
  ...
  public void setup(Renderer renderer, VkRenderPass renderpass, VkDescriptorSetProvider... descriptorsets) throws ThemisException {
    ...
    setMainUniformSetter((binding, buffer, offset, props) -> buffer.set(offset, props.getProperty(MaterialProperties.COLOR_AMBIENT)));
