...
public class TextureMaterialRenderer extends MaterialRenderer {
  ...
  public static final String IDENTIFIER = "materialRenderer.texture";
  ...
  public TextureMaterialRenderer(Renderer renderer, VkRenderPass renderPass, SceneDescriptorSet sceneDescriptorSet) {
  ...
  public void setup(Renderer renderer, VkRenderPass renderpass, VkDescriptorSetProvider... descriptorsets) throws ThemisException {
    ...
    setVertexInputDescriptor(new VkVertexInputStateDescriptor(VK_VERTEX_INPUT_RATE_VERTEX).attribute(VK_FORMAT_R32G32B32_SFLOAT, MemorySizeUtils.VEC3F) // Position
    ...
    setVariantsCombinedImageSamplerSetter((binding, descriptorset, sampler, props) -> descriptorset.bind(binding, props.getProperty(MaterialProperties.TEXTURE_ALBEDO).getView(), sampler));
