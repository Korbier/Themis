...
public class SceneSphereRendererActivity extends BaseRendererActivity {

    private final static String SHADER_VERTEX_SOURCE = "src/main/resources/playground/scene/sphere/vertex_shader.glsl";
    private final static String SHADER_VERTEX_COMPILED = "target/playground/scene/sphere/vertex_shader.spirv";
    private final static String SHADER_FRAGMENT_SOURCE = "src/main/resources/playground/scene/sphere/fragment_shader.glsl";
    private final static String SHADER_FRAGMENT_COMPILED = "target/playground/scene/sphere/fragment_shader.spirv";
    ...
    public SceneSphereRendererActivity(Configuration configuration) {
        super(configuration);
    }
