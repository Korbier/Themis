...
public class SceneTriangle2RendererActivity extends BaseRendererActivity {
  ...
  private static final String SHADER_VERTEX_SOURCE =
      "src/main/resources/playground/scene/triangle2/vertex_shader.glsl";
  private static final String SHADER_VERTEX_COMPILED =
      "target/playground/scene/triangle2/vertex_shader.spirv";
  private static final String SHADER_FRAGMENT_SOURCE =
      "src/main/resources/playground/scene/triangle2/fragment_shader.glsl";
  private static final String SHADER_FRAGMENT_COMPILED =
      "target/playground/scene/triangle2/fragment_shader.spirv";
