...
public class DirectionalLightTest {
    ...
    public void testConstructor_01() {
        ...
        //When
        DirectionalLight light = new DirectionalLight( ambiantColor, diffuseColor, specularColor, direction );
    ...
    public void testSceneAdd_01() {
        ...
        Assertions.assertEquals( scene.getDirectionalLights().getFirst().getAmbient(), light.getAmbient() );
        Assertions.assertEquals( scene.getDirectionalLights().getFirst().getDiffuse(), light.getDiffuse() );
        Assertions.assertEquals( scene.getDirectionalLights().getFirst().getSpecular(), light.getSpecular() );
        Assertions.assertEquals( scene.getDirectionalLights().getFirst().getDirection(), light.getDirection() );
