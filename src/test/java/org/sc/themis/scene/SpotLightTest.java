...
public class SpotLightTest {
    ...
    public void testConstructor_01() {
        ...
        //When
        SpotLight light = new SpotLight( ambiantColor, diffuseColor, specularColor, direction, position, attenuation, innerCutOff, outerCutOff );
    ...
    public void testSceneAdd_01() {
        ...
        Assertions.assertEquals( scene.getSpotLights().getFirst().getAttenuation(), light.getAttenuation() );
        Assertions.assertEquals( scene.getSpotLights().getFirst().getInnerCutOff(), light.getInnerCutOff() );
        Assertions.assertEquals( scene.getSpotLights().getFirst().getOuterCutOff(), light.getOuterCutOff() );
